                        ...
                        <div className="relative z-10">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="flex justify-between items-center bg-white/5 hover:bg-white/10 transition-colors p-5 rounded-2xl border border-white/10 backdrop-blur-sm">
                                    ...
                                    <span className="font-mono font-bold text-lg tracking-widest text-white">01 02 03 04 05</span>
                                </div>
                                <div className="flex justify-between items-center bg-white/5 hover:bg-white/10 transition-colors p-5 rounded-2xl border border-white/10 backdrop-blur-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-bold text-orange-50">Orange</span>
                                    </div>
                                    <span className="font-mono font-bold text-lg tracking-widest text-white">05 06 07 08 09</span>
                                </div>
                            </div>
                        </div>
                    </div>
